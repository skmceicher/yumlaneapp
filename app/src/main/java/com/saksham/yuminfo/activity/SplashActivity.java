package com.saksham.yuminfo.activity;
...
import com.saksham.yuminfo.view.kbv.KenBurnsView;
...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                //Intent i = new Intent(SplashActivity.this, DecideActivity.class);
                //startActivity(i);
                Intent openMainActivity= new Intent("com.saksham.courseinfo.login.DECIDEACTIVITY");
